          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              {!isLoggedIn ? (
                ...
                <li>
                  <button onClick={toggleDropdown} style={{height:"50px",width:"50px",borderRadius:"50%",color: 'white', fontWeight: "800", fontSize: "30px",textAlign:"right"}} className="running-border profile" >{Email.charAt(1).toUpperCase()} </button>
                  {/* <button onClick={toggleDropdown} style={{ width: '50px', height: '50px', borderRadius: '50%', marginTop: '10px', backgroundColor: "transparent", color: 'white', fontWeight: "800", fontSize: "30px" }} className="running-border profile">{Email.charAt(1).toUpperCase()}</button> */}
